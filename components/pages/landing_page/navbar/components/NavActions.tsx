...
export function NavActions() {
  ...
  return (
    <div className="flex items-center gap-1.5 sm:gap-3 shrink-0">
      ...
      {/* CTA Button — with animated gradient shimmer */}
      <motion.a
        href="#contact-us"
        whileHover={{ scale: 1.03 }}
        whileTap={{ scale: 0.97 }}
        transition={{ type: "spring", stiffness: 400, damping: 25 }}
        className="hidden sm:inline-flex items-center justify-center px-6 py-2.5 text-sm font-semibold text-black rounded-lg relative overflow-hidden group"
      >
        ...
        {/* Glow pulse */}
        <span className="absolute inset-0 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 shadow-[0_0_25px_rgba(45,197,244,0.4)]" />
